...
INSERT INTO `commodity` VALUES (8,'MacBook','',3,7,9288,8288,7288,6288,5,NULL,'12 英寸 (对角线) LED 背光 Retina 显示屏',1,'2016-05-11'),(9,'MacBook Air','',3,7,6288,5288,4288,3288,10,NULL,'11.6 英寸 (对角线) LED 背光宽显示屏',1,'2016-05-31'),(10,'MacBook Pro','',3,7,14288,13288,12288,11288,10,NULL,'15.4 英寸 (对角线) LED 背光 Retina 显示屏',1,'2016-05-29'),(11,'iMac','',2,7,7988,6988,5988,4988,10,NULL,'21.5 英寸 (对角线) LED 背光显示屏',1,'2015-05-27');
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='入库详单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `purchase_returned_detail` (
  ...
  PRIMARY KEY (`prdId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='进购退货详单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `purchasegoods` (
  ...
  `returnedAmount` int(11) DEFAULT '0' COMMENT '退货数量',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='进货单商品信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sale_detail` (
  ...
  `returnedAmount` int(11) DEFAULT NULL COMMENT '退货数量',
  PRIMARY KEY (`sdId`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='销售单商品信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sale_detail` VALUES (1,'XSDD201505280001',8,9288,1,9288,1),(2,'XSDD201505280002',8,8288,2,16576,0),(3,'XSDD201505280003',8,6288,2,12576,0),(4,'XSDD201505280004',8,9288,5,46440,0),(5,'XSDD201505290001',9,5288,2,10576,0),(8,'XSDD201505290002',8,8288,5,41440,0),(9,'XSDD201505290003',8,8288,1,8288,0),(10,'XSDD201505300001',8,9288,5,46440,0),(11,'XSDD201505300001',9,6288,5,31440,0);
...
CREATE TABLE `sale_detail_source` (
  ...
  PRIMARY KEY (`sdsId`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='销售单_商品来源';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sale_detail_source` VALUES (1,'XSDD201505280001',1,1,1),(2,'XSDD201505280002',2,1,2),(3,'XSDD201505280003',3,1,2),(4,'XSDD201505280004',4,1,5),(5,'XSDD201505290001',5,2,2),(7,'XSDD201505290002',8,1,5),(8,'XSDD201505290003',9,1,1),(9,'XSDD201505300001',10,1,4),(10,'XSDD201505300001',10,11,1),(11,'XSDD201505300001',11,2,5);
...
CREATE TABLE `sale_return_detail` (
  ...
  PRIMARY KEY (`srdId`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='销售退货详单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sale_return_detail` VALUES (1,'THXS201505290001',1,9288,1,9288);
...
INSERT INTO `sale_return_total` VALUES ('THXS201505290001','XSDD201505280001','2015-05-29 09:10:19','2015-05-29 09:10:22','2015-05-29 09:11:24',9288,1,1,'');
...
CREATE TABLE `sale_stockout_detail` (
  ...
  `sdId` int(11) DEFAULT NULL COMMENT '销售详单ID',
  PRIMARY KEY (`sodId`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='销售出库详单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sale_stockout_detail` VALUES (1,'CKXS201505280001',4),(2,'CKXS201505290001',1);
...
INSERT INTO `sale_stockout_total` VALUES ('CKXS201505280001','XSDD201505280004','2015-05-28 10:38:30','2015-05-28 10:38:33',2,''),('CKXS201505290001','XSDD201505280001','2015-05-29 09:09:35','2015-05-29 09:09:39',1,'');
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='中间表_库存信息_剩余量';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shelfremain` VALUES (1,'RKJH201505280001',1,NULL,0,14),(2,'RKJH201505280001',2,NULL,3,10),(3,'RKJH201505280001',3,NULL,10,10),(4,'RKJH201505280001',4,NULL,5,5),(5,'RKJH201505280002',5,NULL,5,5),(6,'RKJH201505280002',6,NULL,5,5),(7,'RKJH201505280003',7,NULL,15,15),(8,'RKJH201505280004',8,NULL,5,5),(9,'RKJH201505280005',9,NULL,5,5),(10,'RKTH201505290001',1,8,1,1),(11,'RKJH201505290001',10,NULL,9,10);
...
INSERT INTO `stock` VALUES (1,8,4,21,6,1,15),(2,9,1,10,0,3,10),(3,10,3,10,0,10,10),(4,11,2,5,0,5,5),(5,9,2,10,0,10,10),(6,10,1,5,0,5,5),(7,11,4,15,0,15,15),(8,10,2,5,0,5,5),(9,8,1,10,0,9,10);
...
INSERT INTO `totalstock` VALUES (1,8,10,31,6,10,25),(2,9,10,20,0,13,20),(3,10,0,20,0,20,20),(4,11,0,20,0,20,20);
...
-- Dump completed on 2015-05-31 20:53:46
