...
CREATE TABLE `sale_detail` (
  ...
  `returnedAmount` int(11) DEFAULT NULL COMMENT '退货数量',
  PRIMARY KEY (`sdId`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='销售单商品信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sale_detail` VALUES (1,'XSDD201505280001',8,9288,1,9288,1),(2,'XSDD201505280002',8,8288,2,16576,0),(3,'XSDD201505280003',8,6288,2,12576,0),(4,'XSDD201505280004',8,9288,5,46440,0),(5,'XSDD201505290001',9,5288,2,10576,0),(8,'XSDD201505290002',8,8288,5,41440,0),(9,'XSDD201505290003',8,8288,1,8288,0);
...
CREATE TABLE `sale_detail_source` (
  ...
  PRIMARY KEY (`sdsId`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='销售单_商品来源';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sale_detail_source` VALUES (1,'XSDD201505280001',1,1,1),(2,'XSDD201505280002',2,1,2),(3,'XSDD201505280003',3,1,2),(4,'XSDD201505280004',4,1,5),(5,'XSDD201505290001',5,2,2),(7,'XSDD201505290002',8,1,5),(8,'XSDD201505290003',9,1,1);
...
INSERT INTO `sale_total` VALUES ('XSDD201505280001',1,'2015-05-28 10:31:02','2015-05-29 09:09:39',9288,9288,1,1,1,''),('XSDD201505280002',2,'2015-05-28 10:33:30',NULL,16576,16576,1,0,1,''),('XSDD201505280003',4,'2015-05-28 10:33:53',NULL,12576,12576,1,0,1,''),('XSDD201505280004',1,'2015-05-28 10:34:06','2015-05-28 10:38:33',46440,46440,1,1,1,''),('XSDD201505290001',2,'2015-05-29 08:38:54',NULL,10576,10576,1,0,1,''),('XSDD201505290002',2,'2015-05-29 08:53:37',NULL,41440,41440,1,0,1,''),('XSDD201505290003',2,'2015-05-29 08:54:01',NULL,8288,8288,1,0,1,'');
...
INSERT INTO `shelfremain` VALUES (1,'RKJH201505280001',1,NULL,4,14),(2,'RKJH201505280001',2,NULL,8,10),(3,'RKJH201505280001',3,NULL,10,10),(4,'RKJH201505280001',4,NULL,5,5),(5,'RKJH201505280002',5,NULL,5,5),(6,'RKJH201505280002',6,NULL,5,5),(7,'RKJH201505280003',7,NULL,15,15),(8,'RKJH201505280004',8,NULL,5,5),(9,'RKJH201505280005',9,NULL,5,5),(10,'RKTH201505290001',1,8,1,1),(11,'RKJH201505290001',10,NULL,10,10);
...
INSERT INTO `stock` VALUES (1,8,4,21,6,5,15),(2,9,1,10,0,8,10),(3,10,3,10,0,10,10),(4,11,2,5,0,5,5),(5,9,2,10,0,10,10),(6,10,1,5,0,5,5),(7,11,4,15,0,15,15),(8,10,2,5,0,5,5),(9,8,1,10,0,10,10);
...
INSERT INTO `supplier` VALUES (8,'东平商贸公司','东平','81882987','山东济南市山大路',''),(9,' 广州市晨虹科技有限公司','巫剑锋','89101504','广东广州市广州市天河路518号南方现代科技广场',''),(10,'安徽省铜陵市互联电脑商场','刘峰柏','2662038','安徽铜陵市银杏商贸城七号楼外侧301-303室','C客户的公司');
...
INSERT INTO `totalstock` VALUES (1,8,0,31,6,15,25),(2,9,0,20,0,18,20),(3,10,0,20,0,20,20),(4,11,0,20,0,20,20);
...
-- Dump completed on 2015-05-30 10:03:41
